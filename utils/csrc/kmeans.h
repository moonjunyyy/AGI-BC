...
static int Kmeans_setattr(KMeans *self, const char *name, PyObject *v);
static void Kmeans_finalize(KMeans *self);
static PyObject * Kmeans_getattro(KMeans *self, PyObject *name);
...
PyTypeObject KMeansType = {
    ...
    (setattrfunc)Kmeans_setattr,/*tp_setattr*/
    0,                          /*tp_as_async*/
    0,                          /*tp_repr*/
    0,                          /*tp_as_number*/
    0,                          /*tp_as_sequence*/
    ...
    (freefunc)Kmeans_finalize,  /*tp_free*/
    0,                          /*tp_is_gc*/
};
/* --------------------------------------------------------------------- */
...
// static PyObject* new_Kmeans(PyObject *self, PyObject *args);
// static PyMethodDef module_methods[] = {
//     {"KMeans", (PyCFunction)new_Kmeans, METH_VARARGS, "KMeans"},
//     {NULL, NULL} /* sentinel */
// };
