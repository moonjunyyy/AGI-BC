...
for idx, row in df.iterrows():
    ...
    try:
        ...
        print("Audio Error : ", idx + 1, start, end)

    try :
        print("Video : ",idx + 1, start, end)
        ...
        print("Video Error : ", idx + 1, start, end)

    sys.stdout.flush()

    # start = str(datetime.timedelta(seconds=(end-1.5)))
