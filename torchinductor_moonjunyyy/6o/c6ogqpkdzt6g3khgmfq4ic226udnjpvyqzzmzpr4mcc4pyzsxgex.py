...
# kernel path: /data/moonjunyyy/workspace/AGI-BC/torchinductor_moonjunyyy/ec/cecdmkytf4i2iysr76ogzzpx7d6w3mluc7jkhc64iwmrllvjrbcz.py
...
# kernel path: /data/moonjunyyy/workspace/AGI-BC/torchinductor_moonjunyyy/pt/cptbyrnunh3m4tid7rlohqnwurqqdjsvsto5jmqy76o56h47eezh.py
...
def call(args):
    ...
    assert_size_stride(primals_35, (64, 768), (768, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0) # no-op to ensure context
        buf0 = empty((64, 1536), device='cuda', dtype=torch.float32)
        ...
        triton_poi_fused_relu_0.run(buf1, primals_2, 98304, grid=grid(98304), stream=stream0)
        del primals_2
        buf2 = empty((64, 768), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        ...
        buf5 = empty((64, 768), device='cuda', dtype=torch.bool)
        buf6 = empty((64, 768), device='cuda', dtype=torch.float32)
        buf57 = empty((64, 768), device='cuda', dtype=torch.bool)
        # Source Nodes: [add, getattr_l__fn_____0___dropout, getattr_l__fn_____0___relu_1], Original ATen: [aten.add, aten.native_dropout, aten.relu, aten.threshold_backward]
        triton_poi_fused_add_native_dropout_relu_threshold_backward_1.run(buf3, primals_35, buf2, primals_4, buf5, buf6, buf57, 0, 49152, grid=grid(49152), stream=stream0)
        del primals_4
        buf7 = empty((64, 1536), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        ...
        triton_poi_fused_relu_0.run(buf8, primals_6, 98304, grid=grid(98304), stream=stream0)
        del primals_6
        buf9 = buf2; del buf2  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf8, reinterpret_tensor(primals_7, (1536, 768), (1, 1536), 0), out=buf9)
        buf11 = empty((64, 768), device='cuda', dtype=torch.bool)
        buf12 = empty((64, 768), device='cuda', dtype=torch.float32)
        buf56 = empty((64, 768), device='cuda', dtype=torch.bool)
        ...
        triton_poi_fused_add_native_dropout_relu_threshold_backward_1.run(buf3, buf6, buf9, primals_8, buf11, buf12, buf56, 1, 49152, grid=grid(49152), stream=stream0)
        del primals_8
        buf13 = empty((64, 1536), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        ...
        triton_poi_fused_relu_0.run(buf14, primals_10, 98304, grid=grid(98304), stream=stream0)
        del primals_10
        buf15 = buf9; del buf9  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf14, reinterpret_tensor(primals_11, (1536, 768), (1, 1536), 0), out=buf15)
        buf17 = empty((64, 768), device='cuda', dtype=torch.bool)
        buf18 = empty((64, 768), device='cuda', dtype=torch.float32)
        buf55 = empty((64, 768), device='cuda', dtype=torch.bool)
        ...
        triton_poi_fused_add_native_dropout_relu_threshold_backward_1.run(buf3, buf12, buf15, primals_12, buf17, buf18, buf55, 2, 49152, grid=grid(49152), stream=stream0)
        del primals_12
        buf19 = empty((64, 1536), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        ...
        triton_poi_fused_relu_0.run(buf20, primals_14, 98304, grid=grid(98304), stream=stream0)
        del primals_14
        buf21 = buf15; del buf15  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf20, reinterpret_tensor(primals_15, (1536, 768), (1, 1536), 0), out=buf21)
        buf23 = empty((64, 768), device='cuda', dtype=torch.bool)
        buf24 = empty((64, 768), device='cuda', dtype=torch.float32)
        buf54 = empty((64, 768), device='cuda', dtype=torch.bool)
        ...
        triton_poi_fused_add_native_dropout_relu_threshold_backward_1.run(buf3, buf18, buf21, primals_16, buf23, buf24, buf54, 3, 49152, grid=grid(49152), stream=stream0)
        del primals_16
        buf25 = empty((64, 1536), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        ...
        triton_poi_fused_relu_0.run(buf26, primals_18, 98304, grid=grid(98304), stream=stream0)
        del primals_18
        buf27 = buf21; del buf21  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf26, reinterpret_tensor(primals_19, (1536, 768), (1, 1536), 0), out=buf27)
        buf29 = empty((64, 768), device='cuda', dtype=torch.bool)
        buf30 = empty((64, 768), device='cuda', dtype=torch.float32)
        buf53 = empty((64, 768), device='cuda', dtype=torch.bool)
        ...
        triton_poi_fused_add_native_dropout_relu_threshold_backward_1.run(buf3, buf24, buf27, primals_20, buf29, buf30, buf53, 4, 49152, grid=grid(49152), stream=stream0)
        del primals_20
        buf31 = empty((64, 1536), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        ...
        triton_poi_fused_relu_0.run(buf32, primals_22, 98304, grid=grid(98304), stream=stream0)
        del primals_22
        buf33 = buf27; del buf27  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf32, reinterpret_tensor(primals_23, (1536, 768), (1, 1536), 0), out=buf33)
        buf35 = empty((64, 768), device='cuda', dtype=torch.bool)
        buf36 = empty((64, 768), device='cuda', dtype=torch.float32)
        buf52 = empty((64, 768), device='cuda', dtype=torch.bool)
        ...
        triton_poi_fused_add_native_dropout_relu_threshold_backward_1.run(buf3, buf30, buf33, primals_24, buf35, buf36, buf52, 5, 49152, grid=grid(49152), stream=stream0)
        del primals_24
        buf37 = empty((64, 1536), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        ...
        triton_poi_fused_relu_0.run(buf38, primals_26, 98304, grid=grid(98304), stream=stream0)
        del primals_26
        buf39 = buf33; del buf33  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf38, reinterpret_tensor(primals_27, (1536, 768), (1, 1536), 0), out=buf39)
        buf41 = empty((64, 768), device='cuda', dtype=torch.bool)
        buf42 = empty((64, 768), device='cuda', dtype=torch.float32)
        buf51 = empty((64, 768), device='cuda', dtype=torch.bool)
        ...
        triton_poi_fused_add_native_dropout_relu_threshold_backward_1.run(buf3, buf36, buf39, primals_28, buf41, buf42, buf51, 6, 49152, grid=grid(49152), stream=stream0)
        del primals_28
        buf43 = empty((64, 1536), device='cuda', dtype=torch.float32)
        # Source Nodes: [], Original ATen: []
        ...
        triton_poi_fused_relu_0.run(buf44, primals_30, 98304, grid=grid(98304), stream=stream0)
        del primals_30
        buf45 = buf39; del buf39  # reuse
        # Source Nodes: [], Original ATen: []
        extern_kernels.mm(buf44, reinterpret_tensor(primals_31, (1536, 768), (1, 1536), 0), out=buf45)
        buf47 = empty((64, 768), device='cuda', dtype=torch.bool)
        buf48 = empty((64, 768), device='cuda', dtype=torch.float32)
        buf50 = empty((64, 768), device='cuda', dtype=torch.bool)
        ...
        triton_poi_fused_add_native_dropout_relu_threshold_backward_1.run(buf3, buf42, buf45, primals_32, buf47, buf48, buf50, 7, 49152, grid=grid(49152), stream=stream0)
        del buf3
        del buf45
        del primals_32
        buf49 = empty((64, 256), device='cuda', dtype=torch.float32)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    primals_35 = rand_strided((64, 768), (768, 1), device='cuda:0', dtype=torch.float32)
